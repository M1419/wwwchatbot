...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#form01', { style: 'fade-in', speed: 1125, intensity: 5, delay: 250, staggerOrder: '', replay: false });
		onvisible.add('#text03', { style: 'fade-in', speed: 1125, intensity: 5, delay: 250, staggerOrder: '', replay: false });
		onvisible.add('#text02', { style: 'fade-in', speed: 1125, intensity: 5, delay: 250, staggerOrder: '', replay: false });
		onvisible.add('#divider03', { style: 'fade-in', speed: 1125, intensity: 5, delay: 250, staggerOrder: '', replay: false });
